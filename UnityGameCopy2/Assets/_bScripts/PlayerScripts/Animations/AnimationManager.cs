...
public class AnimationManager : MonoBehaviour
{
    ...
    {
        GameManager.Instance.Player.SetPlayerIsSafe(GameManager.Instance.Player.playerAnimator.GetBool("SitDown") || GameManager.Instance.InputManager.AreAllInputsDisabled() );
